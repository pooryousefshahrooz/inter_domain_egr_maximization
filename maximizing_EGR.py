        ...
        for network_topology,file_path in each_network_topology_file.items():
            for edge_fidelity_range in edge_fidelity_ranges:
                for link_cost_metric in link_cost_metrics:
                    network = Network(config,file_path,edge_fidelity_range,link_cost_metric)
                                ...
                                try:
                                    ...
                                    for purificaion_scheme in purification_schemes:
                                        ...
                                        try:
                                            ...
                                            print(ValueError)
                                        print("for purificaion %s topology %s iteration %s from %s  fidelity range %s  path number %s objective_value %s"%
                                        (purificaion_scheme,network_topology,i,experiment_repeat,fidelity_threshold_up_range,num_paths, objective_value))  
...
link_cost_metrics = ["EGR","hop","EGRsquare","Bruteforce"]
